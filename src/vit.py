...
db = mysql.connector.connect(user='root', password='Root.pass', host='localhost', database='hospital')
c = db.cursor()
...
class LoginPage(tk.Frame):
    def __init__(self, master):
        ...
        self.heading = tk.Label(self, text="Hospital Management System", height=5, font=('arial 40 bold'), fg='black',
                                bg='lightgreen').pack()
        ...
        self.submit = tk.Button(self, text="Login", width=20, height=2, bg='steelblue',
                                command=lambda: self.genric(master)).pack()
        self.register = tk.Button(self, text="Register", width=20, height=2, bg='steelblue',
...
class PatientPage(tk.Frame):
    def __init__(self, master):
        ...
        tk.Frame.__init__(self, master)
        self.master = master
        self.heading = tk.Label(self, text="Welcome " + NAME, width=20, height=5, font=('arial 18 bold'), fg='black',
                                bg='lightgreen').pack()
        self.appointment = tk.Button(self, text="Book an appointment", font=('arial 18 bold'),
                                     command=lambda: master.switch_frame(addAppointment)).pack()
        self.result = tk.Button(self, text="Results", font=('arial 18 bold'),
                                command=lambda: master.switch_frame(Results)).pack()
        self.logout = tk.Button(self, text="Logout", font=('arial 18 bold'),
...
class Results(tk.Frame):
    def __init__(self, master):
        ...
        self.back = tk.Button(self, text="Back", font=('arial 18 bold'),
                              command=lambda: master.switch_frame(PatientPage)).pack()
...
class final_list(tk.Frame):
    def __init__(self, master):
        ...
        self.Finish = tk.Button(self, text="Finish", bg='steelblue', width=10,
                                command=lambda: master.switch_frame(PatientPage)).pack(fill="both")
...
class addAppointment(tk.Frame):
    def __init__(self, master):
        ...
        tk.Frame.__init__(self, master)
        self.master = master
        self.heading = tk.Label(self, text="Appointment", width=20, height=5, font=('arial 18 bold'), fg='black',
                                bg='lightgreen').pack()
...
class DoctorPage(tk.Frame):
    def __init__(self, master):
        ...
        tk.Frame.__init__(self, master)
        self.master = master
        self.heading = tk.Label(self, text="Welcome " + NAME, bg="lightgreen", font=('arial 20 bold'), width=30,
                                height=10).pack();
        self.id = tk.Label(self, text="Enter Appointment Id", font=('arial 18 bold'), bg='yellow').pack()
        self.id_ent = tk.Entry(self, width=10)
        self.id_ent.pack()
        ...
        self.Logout = tk.Button(self, text="Logout", bg='steelblue', width=10,
                                command=lambda: master.switch_frame(LoginPage)).pack(fill="both")
...
class UpdateIssue(tk.Frame):
    def __init__(self, master):
        ...
        self.description_ent = tk.Entry(self, width=50)
        self.description_ent.pack()
        self.Update = tk.Button(self, text="Update", bg='steelblue', width=10,
                                command=lambda: self.generic6(master)).pack(fill="both")
...
class ReceptionPage(tk.Frame):
    def __init__(self, master):
        tk.Frame.__init__(self, master)
        self.master = master
        self.heading = tk.Label(self, text="Welcome Admin ", width=20, height=10, font=('arial 20 bold'), fg='black',
                                bg='lightgreen').pack()
        self.id = tk.Label(self, text="Enter Appointment Id", font=('arial 18 bold'), bg='yellow').pack()
        self.id_ent = tk.Entry(self, width=10)
        self.id_ent.pack()
...
class UpdateAppointment(tk.Frame):
    def __init__(self, master):
        ...
        self.did_ent.pack()
        self.Update = tk.Button(self, text="Change", bg='steelblue', width=10,
                                command=lambda: self.generic4(master)).pack(fill="both")
...
class UserRegistration(tk.Frame):
    def __init__(self, master):
        tk.Frame.__init__(self, master)
        self.master = master
        self.heading = tk.Label(self, text="User Registration", width=20, height=10, font=('arial 20 bold'), fg='black',
                                bg='lightgreen').pack(fill='both')
        self.id = tk.Label(self, text="Id", font=('arial 18 bold'), bg='yellow').pack(fill='both')
        self.id_ent = tk.Entry(self, width=10)
        self.id_ent.pack()
        self.fname = tk.Label(self, text="First Name", font=('arial 18 bold'), fg='black', bg='yellow').pack(
            fill='both')
        self.fname_ent = tk.Entry(self, width=30)
        self.fname_ent.pack()
        ...
        self.phone_ent.pack()
        self.button = tk.Button(self, text="Register", bg='steelblue', width=10, height=2,
                                command=lambda: self.genric1(master)).pack(fill="both")
    ...
    def genric1(self, master):
        ...
        if id1 == "" or fname == "" or lname == "" or email == "" or password == "" or role == "" or phone == "":
            tk.messagebox.showinfo("Warning", "Please Fill Up All Boxes")
            return
        c.execute("""INSERT INTO user VALUES (%s,%s,%s,%s,%s,%s,%s) """,
                  (id1, fname, lname, email, role, phone, password))
        tk.messagebox.showinfo("Congrats", "Registration Successfull!!")
        db.commit()
