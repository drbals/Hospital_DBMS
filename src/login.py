...
label_0 = Label(self, text="Login/Signup",width=20,font=("bold", 20))
label_0.place(x=90,y=10)

var = IntVar()
Radiobutton(self, text="Patient", padx=5, variable=var, value=1, font=("bold", 10)).place(x=150, y=80)
Radiobutton(self, text="Doctor", padx=5, variable=var, value=2, font=("bold", 10)).place(x=220, y=80)
Radiobutton(self, text="Staff", padx=5, variable=var, value=3, font=("bold", 10)).place(x=290, y=80)



label_1 = Label(self, text="Email ID",width=20,font=("bold", 10))
...
Button(self, text='  Login  ',bg='brown',fg='white',command=login).place(x=250,y=250)

Button(self, text='Sign Up',command=signup).place(x=170,y=250)
